                ...
                @forelse($fundraising_withdrawals as $fundraising_withdrawal)
                    <div class="item-card flex flex-row justify-between items-center">
                        ...
                        <div class="hidden md:flex flex-row items-center gap-x-3">
                            <a href="{{ route('admin.fundraising_withdrawals.show', $fundraising_withdrawal) }}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                                View Details
                            </a>
                        </div>
                    </div>
                @empty
                    <p class="text-center">Belum ada withdrawal request saat ini</p>
                @endforelse
            </div>
        </div>
    </div>
