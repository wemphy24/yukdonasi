    ...
    <div class="header flex flex-col bg-[#56BBC5] overflow-hidden h-[350px] relative -mb-[92px]">
        <nav class="pt-5 px-3 flex justify-between items-center relative z-20">
            <div class="flex items-center gap-[10px]">
                <a href="{{ route('front.category', $fundraising->category) }}" class="w-10 h-10 flex shrink-0">
    ...
    <div class="flex flex-col z-30">
        ...
        <div id="content" class="w-full bg-white rounded-t-[40px] flex flex-col gap-5 p-[30px_24px_120px]">
            ...
            <div class="flex flex-col gap-[2px]">
                ...
                <p class="desc-less text-sm leading-[26px]">{{ $fundraising->about }} <button class="text-[#FF7815] underline" onclick="toggleSeeMoreLess()">see more</button></p>
                <p class="desc-more text-sm leading-[26px] hidden">{{ $fundraising->about }} <button class="text-[#FF7815] underline" onclick="toggleSeeMoreLess()">see less</button></p>
            </div>
            <div class="flex flex-col gap-3">
                ...
                @empty
                <p class="text-cente">Belum ada donatur saat ini</p>
                @endforelse
            </div>
        </div>
    </div>
